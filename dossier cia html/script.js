...
function updateDossier(id, updatedData) {
    const dossiers = getAllDossiers();
...
function addDocument(dossierId, document) {
    const documents = JSON.parse(localStorage.getItem(DOCUMENTS_KEY)) || [];
...
function updateDocument(dossierId, docId, updatedData) {
    const documents = JSON.parse(localStorage.getItem(DOCUMENTS_KEY)) || [];
...
function deleteDocument(dossierId, docId) {
    const documents = JSON.parse(localStorage.getItem(DOCUMENTS_KEY)) || [];
...
function addImage(dossierId, image) {
    const images = JSON.parse(localStorage.getItem(IMAGES_KEY)) || [];
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (addDossierForm) {
        addDossierForm.addEventListener('submit', function(e) {
            e.preventDefault();
    ...
    if (addDocumentFileForm) {
        addDocumentFileForm.addEventListener('submit', function(e) {
            e.preventDefault();
        ...
        addImageForm.addEventListener('submit', function(e) {
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    ...
                    addImage(document.getElementById('selectDossierImage').value, image);
